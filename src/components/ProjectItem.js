...
function ProjectItem({ project }) {
    ...
    const { name, description, img, link, github, features, techStacks } = project

    return (
        <Grid templateColumns="repeat(2, 1fr)" className='layout' gap={8} p='6' rounded='xl' mb='12' mx={{ base: '4', md: '8' }}>
            <GridItem display={'grid'} colSpan={{ base: 2, md: 1 }}>
                ...
                <Flex mb='1' gap={4} mx='12' mt='6'>
                    <Box transition={'all 0.3s ease-in-out'} _hover={{ transform: 'translateY(-5px)' }} w='100%'>
                        <Box className='button' rounded='lg' px='8' py='4' align="center" fontWeight="semibold" fontSize='14px' color="#ff014f">View Project</Box>
                    </Box>
                    <Box transition={'all 0.3s ease-in-out'} _hover={{ transform: 'translateY(-5px)' }} w='100%'>
                        <Box className='button' rounded='lg' px='8' py='4' align="center" fontWeight="semibold" fontSize='14px' color="#ff014f">View Code</Box>
                    </Box>
                </Flex>
            </GridItem>
            <GridItem colSpan={{ base: 2, md: 1 }} mt={{ base: '0', md: '1',lg:'2', xl:'4' }}>
                ...
                <Box display={{ base: 'block', md: 'none', lg: 'grid' }} mt={{ base: '2', md: '4',lg:'6', xl:'8' }} >
